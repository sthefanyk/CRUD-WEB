...
function cadastrarUsuario(nome, email, disciplina, senha) {
    ...
    axios.post('http://infopguaifpr.com.br:3052/cadastrarUsuario', user, {
        header: {
...
document.addEventListener('click', function (event) {
    if (event.target && event.target.className.contains('btn-delete')) {
...
function deletarUsuario(id) {
    axios.post(`http://infopguaifpr.com.br:3052/deletarUsuario/${id}`)
    .then(response => {
